...
public class Login extends JFrame {
	...
	private void LoginUser() {
		String contrasenhaInput = new String(txtContrasena.getPassword());
		String usuarioInput = txtUsuario.getText();
		
		Usuario usuario = new Usuario(usuarioInput, contrasenhaInput);
		usuarioController = new UsuarioController();	
		menuUsuario(usuarioController.LoginUser(usuario));
	}
	
	private void menuUsuario(Boolean conexionCorrecta) {
		if (conexionCorrecta) {

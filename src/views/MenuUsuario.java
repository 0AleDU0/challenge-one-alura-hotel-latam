...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva de hotel. Controle y administre de forma optima y facil <br> el flujo de reservas y de huespedes del hotel   </body></html>";
	    ...
	    String textoDescripcion1 = "<html><body> Esta herramienta le permitira llevar un control completo y detallado de sus reservas y huespedes, tendra acceso a heramientas especiales para tareas especificas como lo son:</body></html>";
	    ...
	    String[] engrosadodeTxt = {"<html><body><span style='font-weight: bold;'>", "</span></html></body>"};
        String[] textosOpciones = {
                "- Registro de Reservas y Huespedes",
                "- Edición de Reservas y Huespedes",
                "- Eliminar todo tipo de registros"
            };
        
	    JLabel lblNewLabel_3 = new JLabel(engrosadodeTxt[0] + textosOpciones[0] + engrosadodeTxt[1]);
	    lblNewLabel_3.setFont(new Font("Roboto", Font.PLAIN, 17));
	    lblNewLabel_3.setBounds(312, 444, 295, 27);
	    contentPane.add(lblNewLabel_3);
	    
	    JLabel lblNewLabel_3_1 = new JLabel(engrosadodeTxt[0] + textosOpciones[1] + engrosadodeTxt[1]);
	    lblNewLabel_3_1.setFont(new Font("Roboto", Font.PLAIN, 17));
	    lblNewLabel_3_1.setBounds(312, 482, 355, 27);
	    contentPane.add(lblNewLabel_3_1);
	    
	    JLabel lblNewLabel_3_2 = new JLabel(engrosadodeTxt[0] + textosOpciones[2] + engrosadodeTxt[1]);
